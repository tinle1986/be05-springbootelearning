...
public class AdminAuthenticationController {
  ...
  public AdminAuthenticationController(UserService userService, AuthenticationManager adminAuthenticationManager) {
  ...
  public ResponseEntity<?> signIn(@RequestBody LoginDto loginDto) {
    try {
      Authentication authentication = adminAuthenticationManager.authenticate(new UsernamePasswordAuthenticationToken(loginDto.getEmail(), loginDto.getPassword()));
